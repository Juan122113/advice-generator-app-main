...
function App() {
  ...
  return (
    <main className="min-h-screen bg-[#1f2632] flex flex-col items-center relative">
      <div className='card h-[19.7rem] bg-[#323a49] flex flex-col items-center justify-center mt-[7.5rem] w-[21.4rem] rounded relative max-w-[95%] lg:mt-[15rem] md:mt-15rem md:bg-red-500 lg:bg-red-500'>
        ...
        <div onClick={fetchData} className='rounded-[50%] bg-[#00FFA0] absolute p-[1.25rem] flex top-[283px] lg:relative'>
